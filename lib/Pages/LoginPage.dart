...
import 'package:sasta_chat_app/Pages/HomePage.dart';
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            Text(
              "Sasta chat app",
              style: GoogleFonts.mcLaren(color: Colors.black, fontSize: 45.0),
            ),
            GestureDetector(
              onTap: controlSignIn,
              child: Center(
    ...
    if (firebaseUser != null) {
      ...
      if (documentSnapshots.length == 0) {
        Firestore.instance
          ...
          "id": firebaseUser.uid,
          "aboutMe": "i am using sasta chat app",
      ...
      Fluttertoast.showToast(msg: "Try again , Sign in Failed you fool");
      this.setState(() {
        isLoading = false;
      });
    }
