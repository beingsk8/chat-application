...
import 'package:sasta_chat_app/Models/user.dart';
import 'package:sasta_chat_app/Pages/ChattingPage.dart';
import 'package:sasta_chat_app/main.dart';
import 'package:sasta_chat_app/Pages/AccountSettingsPage.dart';
    ...
    return Container(
      child: Center(
        child: ListView(
          shrinkWrap: true,
          children: <Widget>[
            Icon(Icons.group, color: Colors.lightBlue, size: 200.0),
            Text(
              "search Users",
